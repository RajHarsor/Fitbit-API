...
class Fitbit(object):
    ...
    def time_series(self, resource, user_id=None, base_date='today',
        ...
        if resource == 'sleep':
            url = "{0}/1.2/user/{2}/{resource}/date/{base_date}/{end}.json".format(
    ...
    def activity_PACE_loglist(self, user_id=None, afterDate=None, limit=100):
        """
        ...
        * https://dev.fitbit.com/build/reference/web-api/activity/get-activity-log-list/
        ...
        query_params = []
        if afterDate:
            query_params.append("afterDate={}".format(afterDate))
        if limit:
